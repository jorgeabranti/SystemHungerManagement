...
class AddForeignKeysToPedidosTable extends Migration {
	...
	public function up()
	{
		Schema::table('pedidos', function(Blueprint $table)
		{
			...
			$table->foreign('entregadores_id_entregador', 'fk_pedidos_entregadores1')->references('id_entregador')->on('entregadores')->onUpdate('NO ACTION')->onDelete('NO ACTION');
			$table->foreign('pagamento_pedido_id_pagamento_pedido', 'fk_pedidos_pagamento_pedido1')->references('id_pagamento_pedido')->on('pagamentos_pedidos')->onUpdate('NO ACTION')->onDelete('NO ACTION');
	...
	public function down()
	{
		Schema::table('pedidos', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_pedidos_entregadores1');
