...
class CreatePedidosTable extends Migration {
	...
	public function up()
	{
		Schema::create('pedidos', function(Blueprint $table)
		{
			...
			$table->integer('entregadores_id_entregador')->nullable()->index('fk_pedidos_entregadores1_idx');
		});
	}
